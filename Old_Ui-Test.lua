    ...
    get = function(x)
		...
		elseif x ~= "ronixstudios" then
            ...
            if success and res and res.Body then
                ...
                if ok and parsed and parsed.guild and parsed.guild.id and parsed.guild.icon then
                    local iconUrl = ("https://cdn.discordapp.com/icons/%s/%s.png?size=256"):format(parsed.guild.id, parsed.guild.icon)
                    local imgSuccess, imgRes = pcall(function()
                        return request({
                            Url = iconUrl,
                            Method = "GET",
                    ...
                    if imgSuccess and imgRes and imgRes.Body and imgRes.Body ~= "" then
                        pcall(function()
							if not isfile(path) then
...
UI["5"]["Image"] = asset_mgr.get(110756439405662)
...
UI["10"]["Image"] = asset_mgr.get("ronixstudios")
...
UI["16"]["Image"] = asset_mgr.get("search")
...
UI["17"]["Size"] = UDim2.new(0.350, 0, 0.350, 0)
...
UI["1b"]["Image"] = asset_mgr.get(83688012004614);
...
UI["1e"]["Size"] = UDim2.new(0.350, 0, 0.350, 0)
...
UI["22"]["Image"] = asset_mgr.get("chevrons-left-right")
...
UI["26"]["Size"] = UDim2.new(0.350, 0, 0.350, 0)
...
UI["2a"]["Image"] = asset_mgr.get("folder");
...
UI["2b"]["Image"] = asset_mgr.get(83688012004614);
...
UI["2e"]["Size"] = UDim2.new(0.350, 0, 0.350, 0)
...
UI["32"]["Image"] = asset_mgr.get("settings");
...
UI["36"]["Image"] = asset_mgr.get("minimize");
...
UI["43"]["Image"] = asset_mgr.get("play");
...
UI["47"]["Image"] = asset_mgr.get("clipboard-paste");
...
UI["4b"]["Image"] = asset_mgr.get("eraser");
...
-- Join The Community | DISCORD.GG/RONIXSTUDIOS
...
UI["58"]["Image"] = asset_mgr.get(106985554407226);
...
UI["59"]["Size"] = UDim2.new(0.635599971, 0, 0.8768600225448608, 0)
...
-- // StarterGui.RoniXUI.ConfigFrame.UIAspectRatioConstraint \\ --
UI["59_Ratio"] = Instance.new("UIAspectRatioConstraint", UI["59"])
UI["59_Ratio"]["AspectRatio"] = 1.4
UI["59_Ratio"]["DominantAxis"] = Enum.DominantAxis.Height
...
UI["5b"]["Size"] = UDim2.new(0.95, 0, 0.94, 0)
UI["5b"]["AnchorPoint"] = Vector2.new(0.5, 0.5)
UI["5b"]["Position"] = UDim2.new(0.5, 0, 0.5, 0)
...
UI["5e"]["Image"] = asset_mgr.get(106985554407226);
...
UI["5f"]["Size"] = UDim2.new(0.13, 0, 0.07, 0)
UI["5f"]["Name"] = [[Console]]
UI["5f"]["BorderColor3"] = Color3.fromRGB(0, 0, 0)
UI["5f"]["Text"] = [[Console]]
UI["5f"]["Position"] = UDim2.new(0.31, 0, 0.03, 0)
...
UI["62"]["Size"] = UDim2.new(0.13, 0, 0.07, 0)
UI["62"]["Name"] = [[Server]]
UI["62"]["BorderColor3"] = Color3.fromRGB(0, 0, 0)
UI["62"]["Text"] = [[Server]]
UI["62"]["Position"] = UDim2.new(0.02, 0, 0.03, 0)
...
UI["65"]["Size"] = UDim2.new(0.13, 0, 0.07, 0)
UI["65"]["Name"] = [[AutoExe]]
UI["65"]["BorderColor3"] = Color3.fromRGB(0, 0, 0)
UI["65"]["Text"] = [[Auto Execute]]
UI["65"]["Position"] = UDim2.new(0.165, 0, 0.03, 0)
...
UI["68"]["Size"] = UDim2.new(0.95, 0, 0.84, 0)
UI["68"]["Position"] = UDim2.new(0.025, 0, 0.125, 0)
...
UI["69"]["Size"] = UDim2.new(0.25, 0, 0.06, 0)
...
UI["6b"]["Size"] = UDim2.new(1, 0, 0.003, 0)
UI["6b"]["Position"] = UDim2.new(0, 0, 0.14, 0)
...
UI["6c"]["Size"] = UDim2.new(0.13, 0, 0.06, 0)
UI["6c"]["BorderColor3"] = Color3.fromRGB(0, 0, 0)
UI["6c"]["Text"] = [[Server Hop]]
UI["6c"]["Position"] = UDim2.new(0, 0, 0.17, 0)
...
UI["6d"]["Size"] = UDim2.new(0.13, 0, 0.06, 0)
UI["6d"]["BorderColor3"] = Color3.fromRGB(0, 0, 0)
UI["6d"]["Text"] = [[Rejoin Server]]
UI["6d"]["Position"] = UDim2.new(0, 0, 0.26, 0)
...
UI["74"]["Size"] = UDim2.new(0.95, 0, 0.84, 0)
UI["74"]["Position"] = UDim2.new(0.025, 0, 0.125, 0)
...
UI["76"]["Size"] = UDim2.new(1, 0, 0.003, 0)
UI["76"]["Position"] = UDim2.new(0, 0, 0.14, 0)
...
UI["77"]["Size"] = UDim2.new(0.25, 0, 0.06, 0)
...
UI["78"]["Size"] = UDim2.new(1, 0, 0.8, 0)
UI["78"]["ScrollBarImageColor3"] = Color3.fromRGB(0, 0, 0)
UI["78"]["Position"] = UDim2.new(0, 0, 0.2, 0)
...
UI["79"]["RichText"] = true
UI["79"]["Size"] = UDim2.new(1, 0, 0.05, 0)
...
UI["7b"]["Size"] = UDim2.new(0.95, 0, 0.84, 0)
UI["7b"]["Position"] = UDim2.new(0.025, 0, 0.125, 0)
...
UI["7c"]["Size"] = UDim2.new(0.25, 0, 0.06, 0)
...
UI["7e"]["Size"] = UDim2.new(1, 0, 0.003, 0)
UI["7e"]["Position"] = UDim2.new(0, 0, 0.14, 0)
...
UI["81"]["Size"] = UDim2.new(0.3, 0, 0.2, 0)
...
UI["82"]["BackgroundColor3"] = Color3.fromRGB(20, 20, 20)
UI["82"]["Image"] = asset_mgr.get(743601839648)
UI["82"]["Size"] = UDim2.new(1, 0, 1, 0)
UI["82"]["BackgroundTransparency"] = 0
UI["82"]["BorderColor3"] = Color3.fromRGB(0, 0, 0)
UI["82"]["Position"] = UDim2.new(0, 0, 0, 0)
UI["82"]["AutoButtonColor"] = false
...
UI["83"]["CornerRadius"] = UDim.new(0.1, 0)

local CardStroke = Instance.new("UIStroke", UI["82"])
CardStroke.Thickness = 1.2
CardStroke.Transparency = 0.5
CardStroke.Color = Color3.fromRGB(160, 130, 255)
...
UI["84"]["TextYAlignment"] = Enum.TextYAlignment.Bottom
UI["84"]["TextTransparency"] = 0
UI["84"]["TextScaled"] = true
UI["84"]["BackgroundColor3"] = Color3.fromRGB(255, 255, 255)
UI["84"]["FontFace"] = Font.new([[rbxasset://fonts/families/GothamSSm.json]], Enum.FontWeight.Bold, Enum.FontStyle.Normal)
UI["84"]["TextColor3"] = Color3.fromRGB(255, 255, 255)
UI["84"]["BackgroundTransparency"] = 1
UI["84"]["Size"] = UDim2.new(0.9, 0, 0.25, 0)
UI["84"]["BorderColor3"] = Color3.fromRGB(0, 0, 0)
UI["84"]["Name"] = [[NameLabel]]
UI["84"]["Position"] = UDim2.new(0.05, 0, 0.65, 0)
UI["84"]["ZIndex"] = 2

local TextStroke = Instance.new("UIStroke", UI["84"])
...
UI["86"]["ImageTransparency"] = 0
UI["86"]["BackgroundColor3"] = Color3.fromRGB(0, 0, 0)
UI["86"]["BackgroundTransparency"] = 0.5
UI["86"]["Image"] = asset_mgr.get(90565992513886)
UI["86"]["Size"] = UDim2.new(0.2, 0, 0.2, 0)
UI["86"]["Name"] = [[Delete]]
UI["86"]["BorderColor3"] = Color3.fromRGB(0, 0, 0)
UI["86"]["Position"] = UDim2.new(0.75, 0, 0.05, 0)
UI["86"]["ZIndex"] = 2

local DeleteCorner = Instance.new("UICorner", UI["86"])
...
UI["8a"]["CellSize"] = UDim2.new(0.31, 0, 0, 110)
UI["8a"]["SortOrder"] = Enum.SortOrder.LayoutOrder
UI["8a"]["CellPadding"] = UDim2.new(0, 10, 0, 10)
...
UI["8e"]["Size"] = UDim2.new(0.01, 0, 1, 0)
UI["8e"]["Position"] = UDim2.new(0.7, 0, 0, 0)
...
UI["8f"]["Image"] = asset_mgr.get(113548820873804);
UI["8f"]["Size"] = UDim2.new(0.15, 0, 0.5, 0)
UI["8f"]["BorderColor3"] = Color3.fromRGB(0, 0, 0)
UI["8f"]["BackgroundTransparency"] = 1
UI["8f"]["Position"] = UDim2.new(0.07, 0, 0.25, 0)
...
UI["90"]["Size"] = UDim2.new(0.15, 0, 0.4, 0)
UI["90"]["BorderColor3"] = Color3.fromRGB(0, 0, 0)
UI["90"]["Text"] = [[NEW]]
UI["90"]["Position"] = UDim2.new(0.3, 0, 0.3, 0)
...
UI["91"]["Image"] = asset_mgr.get(138665650299046);
UI["91"]["Size"] = UDim2.new(0.15, 0, 0.5, 0)
UI["91"]["BorderColor3"] = Color3.fromRGB(0, 0, 0)
UI["91"]["BackgroundTransparency"] = 1
UI["91"]["Position"] = UDim2.new(0.78, 0, 0.25, 0)
...
UI["92"]["Size"] = UDim2.new(0.77, 0, 0.1, 0)
UI["92"]["Position"] = UDim2.new(0, 0, 0.19, 0)
...
UI["95"]["BackgroundColor3"] = Color3.fromRGB(30, 30, 30)
UI["95"]["AnchorPoint"] = Vector2.new(0.5, 0.5)
UI["95"]["Size"] = UDim2.new(0.5, 0, 0.6, 0)
UI["95"]["Position"] = UDim2.new(0.5, 0, 0.5, 0)
UI["95"]["BorderColor3"] = Color3.fromRGB(0, 0, 0)
UI["95"]["Name"] = [[CreateFrame]]
UI["95"]["BackgroundTransparency"] = 0.05
UI["95"]["ClipsDescendants"] = true

UI["95_Ratio"] = Instance.new("UIAspectRatioConstraint", UI["95"])
UI["95_Ratio"]["AspectRatio"] = 1.4
UI["95_Ratio"]["DominantAxis"] = Enum.DominantAxis.Height

UI["95_Size"] = Instance.new("UISizeConstraint", UI["95"])
UI["95_Size"]["MinSize"] = Vector2.new(250, 200)

UI["96"] = Instance.new("TextBox", UI["95"])
UI["96"]["TextColor3"] = Color3.fromRGB(255, 255, 255)
UI["96"]["PlaceholderColor3"] = Color3.fromRGB(150, 150, 150)
UI["96"]["BorderSizePixel"] = 0
UI["96"]["TextWrapped"] = true
UI["96"]["TextTransparency"] = 0
UI["96"]["TextScaled"] = true
UI["96"]["Name"] = [[Name Script]]
UI["96"]["BackgroundColor3"] = Color3.fromRGB(20, 20, 20)
UI["96"]["FontFace"] = Font.new([[rbxasset://fonts/families/GothamSSm.json]], Enum.FontWeight.Medium, Enum.FontStyle.Normal)
UI["96"]["PlaceholderText"] = [[Script Name]]
UI["96"]["Size"] = UDim2.new(0.85, 0, 0.15, 0)
UI["96"]["Position"] = UDim2.new(0.075, 0, 0.25, 0)
UI["96"]["BorderColor3"] = Color3.fromRGB(0, 0, 0)
UI["96"]["Text"] = [[]]
UI["96"]["BackgroundTransparency"] = 0
UI["96"]["ClearTextOnFocus"] = false

UI["97"] = Instance.new("UICorner", UI["96"])
UI["97"]["CornerRadius"] = UDim.new(0.2, 0)

UI["98"] = Instance.new("LocalScript", UI["96"])

UI["99"] = Instance.new("UIStroke", UI["96"])
UI["99"]["Transparency"] = 0.6
UI["99"]["ApplyStrokeMode"] = Enum.ApplyStrokeMode.Border
UI["99"]["Color"] = Color3.fromRGB(80, 80, 80)

UI["9a"] = Instance.new("TextBox", UI["95"])
UI["9a"]["TextColor3"] = Color3.fromRGB(255, 255, 255)
UI["9a"]["PlaceholderColor3"] = Color3.fromRGB(150, 150, 150)
UI["9a"]["BorderSizePixel"] = 0
UI["9a"]["TextWrapped"] = true
UI["9a"]["TextTransparency"] = 0
UI["9a"]["TextScaled"] = true
UI["9a"]["Name"] = [[Script Code]]
UI["9a"]["BackgroundColor3"] = Color3.fromRGB(20, 20, 20)
UI["9a"]["FontFace"] = Font.new([[rbxasset://fonts/families/GothamSSm.json]], Enum.FontWeight.Medium, Enum.FontStyle.Normal)
UI["9a"]["PlaceholderText"] = [[Paste Script Here]]
UI["9a"]["Size"] = UDim2.new(0.85, 0, 0.15, 0)
UI["9a"]["Position"] = UDim2.new(0.075, 0, 0.48, 0)
UI["9a"]["BorderColor3"] = Color3.fromRGB(0, 0, 0)
UI["9a"]["Text"] = [[]]
UI["9a"]["BackgroundTransparency"] = 0
UI["9a"]["ClearTextOnFocus"] = false

UI["9b"] = Instance.new("UICorner", UI["9a"])
UI["9b"]["CornerRadius"] = UDim.new(0.2, 0)

UI["9c"] = Instance.new("LocalScript", UI["9a"])

UI["9d"] = Instance.new("UIStroke", UI["9a"])
UI["9d"]["Transparency"] = 0.6
UI["9d"]["ApplyStrokeMode"] = Enum.ApplyStrokeMode.Border
UI["9d"]["Color"] = Color3.fromRGB(80, 80, 80)

UI["9e"] = Instance.new("UICorner", UI["95"])
UI["9e"]["CornerRadius"] = UDim.new(0.08, 0)

UI["9f"] = Instance.new("UIStroke", UI["95"])
UI["9f"]["Color"] = Color3.fromRGB(160, 130, 255)
UI["9f"]["Thickness"] = 1.5

UI["a0"] = Instance.new("TextButton", UI["95"])
UI["a0"]["BorderSizePixel"] = 0
UI["a0"]["TextTransparency"] = 0
UI["a0"]["TextScaled"] = true
UI["a0"]["SelectionOrder"] = 1
UI["a0"]["TextColor3"] = Color3.fromRGB(255, 255, 255)
UI["a0"]["BackgroundColor3"] = Color3.fromRGB(160, 130, 255)
UI["a0"]["FontFace"] = Font.new([[rbxasset://fonts/families/GothamSSm.json]], Enum.FontWeight.Bold, Enum.FontStyle.Normal)
UI["a0"]["Size"] = UDim2.new(0.85, 0, 0.15, 0)
UI["a0"]["BackgroundTransparency"] = 0.2
UI["a0"]["Name"] = [[Create]]
UI["a0"]["BorderColor3"] = Color3.fromRGB(0, 0, 0)
UI["a0"]["Text"] = [[CREATE]]
UI["a0"]["Position"] = UDim2.new(0.075, 0, 0.75, 0)

UI["a1"] = Instance.new("UICorner", UI["a0"])
UI["a1"]["CornerRadius"] = UDim.new(0.2, 0)

UI["a2"] = Instance.new("UIStroke", UI["a0"])
UI["a2"]["Transparency"] = 0.5
...
UI["a3"]["TextColor3"] = Color3.fromRGB(200, 200, 200)
UI["a3"]["BackgroundColor3"] = Color3.fromRGB(0, 0, 0)
UI["a3"]["FontFace"] = Font.new([[rbxasset://fonts/families/GothamSSm.json]], Enum.FontWeight.Bold, Enum.FontStyle.Normal)
UI["a3"]["Size"] = UDim2.new(0.1, 0, 0.1, 0)
UI["a3"]["BackgroundTransparency"] = 1
UI["a3"]["Name"] = [[Exit]]
UI["a3"]["BorderColor3"] = Color3.fromRGB(0, 0, 0)
UI["a3"]["Text"] = [[X]]
UI["a3"]["Position"] = UDim2.new(0.88, 0, 0.02, 0)
UI["a3"]["ZIndex"] = 5
...
UI["a6"]["FontFace"] = Font.new([[rbxasset://fonts/families/GothamSSm.json]], Enum.FontWeight.Bold, Enum.FontStyle.Normal)
UI["a6"]["TextColor3"] = Color3.fromRGB(255, 255, 255)
UI["a6"]["BackgroundTransparency"] = 1
UI["a6"]["Size"] = UDim2.new(0.85, 0, 0.12, 0)
UI["a6"]["BorderColor3"] = Color3.fromRGB(0, 0, 0)
UI["a6"]["Text"] = [[Create File For Auto Exec]]
UI["a6"]["Position"] = UDim2.new(0.075, 0, 0.05, 0)
UI["a6"]["ZIndex"] = 2
...
UI["ad"]["Image"] = asset_mgr.get(106985554407226);
...
UI["af"]["Size"] = UDim2.new(0.99, 0, 0.850, 0)
UI["af"]["ScrollBarImageColor3"] = Color3.fromRGB(0, 0, 0)
UI["af"]["Position"] = UDim2.new(0.5, 0, 0.55, 0)
UI["af"]["BorderColor3"] = Color3.fromRGB(0, 0, 0)
UI["af"]["BackgroundTransparency"] = 1
UI["af"]["ScrollBarThickness"] = 6
UI["af"].AnchorPoint = Vector2.new(0.5, 0.5)

local ListPadding = Instance.new("UIPadding", UI["af"])
...
UI["b0"]["Size"] = UDim2.new(0.3, 0, 0.2, 0) 
...
UI["b1"]["BackgroundColor3"] = Color3.fromRGB(20, 20, 20)
UI["b1"]["Image"] = asset_mgr.get(743601839648)
UI["b1"]["Size"] = UDim2.new(1, 0, 1, 0)
UI["b1"]["BackgroundTransparency"] = 0 
UI["b1"]["BorderColor3"] = Color3.fromRGB(0, 0, 0)
UI["b1"]["Position"] = UDim2.new(0, 0, 0, 0)
UI["b1"]["AutoButtonColor"] = false
UI["b1"]["ClipsDescendants"] = true

-- // StarterGui.RoniXUI.FolderFrame.Frame.ScrollingFrame.ScriptFrame.ImageButton.UICorner \\ --
UI["b2"] = Instance.new("UICorner", UI["b1"])
UI["b2"]["CornerRadius"] = UDim.new(0, 8)

local CardStroke = Instance.new("UIStroke", UI["b1"])
CardStroke.Thickness = 1.2
CardStroke.Transparency = 0.5
CardStroke.Color = Color3.fromRGB(194, 131, 106)
CardStroke.ApplyStrokeMode = Enum.ApplyStrokeMode.Border
...
UI["b3"]["TextYAlignment"] = Enum.TextYAlignment.Bottom
UI["b3"]["TextTransparency"] = 0
UI["b3"]["TextScaled"] = false
UI["b3"]["BackgroundColor3"] = Color3.fromRGB(255, 255, 255)
UI["b3"]["TextSize"] = 14
UI["b3"]["FontFace"] = Font.new([[rbxasset://fonts/families/GothamSSm.json]], Enum.FontWeight.Bold, Enum.FontStyle.Normal)
UI["b3"]["TextColor3"] = Color3.fromRGB(255, 255, 255)
UI["b3"]["BackgroundTransparency"] = 1
UI["b3"]["Size"] = UDim2.new(0.9, 0, 0.3, 0)
UI["b3"]["BorderColor3"] = Color3.fromRGB(0, 0, 0)
UI["b3"]["Name"] = [[NameLabel]]
UI["b3"]["Position"] = UDim2.new(0.05, 0, 0.65, 0)
UI["b3"]["ZIndex"] = 2

local TextStroke = Instance.new("UIStroke", UI["b3"])
TextStroke.Thickness = 2
TextStroke.Transparency = 0
TextStroke.Color = Color3.fromRGB(0, 0, 0)
...
UI["b5"]["ImageTransparency"] = 0
UI["b5"]["BackgroundColor3"] = Color3.fromRGB(0, 0, 0)
UI["b5"]["BackgroundTransparency"] = 0.5
UI["b5"]["Image"] = asset_mgr.get(90565992513886)
UI["b5"]["Size"] = UDim2.new(0.25, 0, 0.25, 0)
UI["b5"]["Name"] = [[Delete]]
UI["b5"]["BorderColor3"] = Color3.fromRGB(0, 0, 0)
UI["b5"]["Position"] = UDim2.new(0.85, 0, 0.05, 0)
UI["b5"]["ZIndex"] = 2

local DeleteCorner = Instance.new("UICorner", UI["b5"])
...
UI["b9"]["CellSize"] = UDim2.new(0.31, 0, 0, 110) 
UI["b9"]["SortOrder"] = Enum.SortOrder.LayoutOrder
UI["b9"]["CellPadding"] = UDim2.new(0, 10, 0, 10)
...
UI["bf"]["Color"] = Color3.fromRGB(49, 41, 85)
UI["bf"].Thickness = 1.5
...
UI["c1"]["Image"] = asset_mgr.get(113548820873804);
...
UI["c3"]["Image"] = asset_mgr.get(138665650299046);
...
UI["c4"]["BackgroundColor3"] = Color3.fromRGB(30, 30, 30)
UI["c4"]["Size"] = UDim2.new(0.4, 0, 0.6, 0)
UI["c4"]["Position"] = UDim2.new(0.3, 0, 0.2, 0)
UI["c4"]["BorderColor3"] = Color3.fromRGB(0, 0, 0)
UI["c4"]["Name"] = [[CreateFrame]]
UI["c4"]["BackgroundTransparency"] = 0.05
UI["c4"]["ClipsDescendants"] = true
UI["c4"]["ZIndex"] = 2
...
UI["c5"]["PlaceholderColor3"] = Color3.fromRGB(150, 150, 150)
UI["c5"]["BorderSizePixel"] = 0
UI["c5"]["TextWrapped"] = true
UI["c5"]["TextTransparency"] = 0
UI["c5"]["TextSize"] = 15
UI["c5"]["Name"] = [[Name Script]]
UI["c5"]["BackgroundColor3"] = Color3.fromRGB(20, 20, 20)
...
UI["c5"]["Size"] = UDim2.new(0.85, 0, 0.18, 0)
UI["c5"]["Position"] = UDim2.new(0.075, 0, 0.25, 0)
UI["c5"]["BorderColor3"] = Color3.fromRGB(0, 0, 0)
UI["c5"]["Text"] = [[]]
UI["c5"]["BackgroundTransparency"] = 0
...
UI["c8"]["Transparency"] = 0.6
UI["c8"]["ApplyStrokeMode"] = Enum.ApplyStrokeMode.Border
UI["c8"]["Color"] = Color3.fromRGB(80, 80, 80)
...
UI["c9"]["PlaceholderColor3"] = Color3.fromRGB(150, 150, 150)
UI["c9"]["BorderSizePixel"] = 0
UI["c9"]["TextWrapped"] = true
UI["c9"]["TextTransparency"] = 0
UI["c9"]["TextSize"] = 15
UI["c9"]["Name"] = [[Script Code]]
UI["c9"]["BackgroundColor3"] = Color3.fromRGB(20, 20, 20)
UI["c9"]["FontFace"] = Font.new([[rbxasset://fonts/families/GothamSSm.json]], Enum.FontWeight.Medium, Enum.FontStyle.Normal)
UI["c9"]["PlaceholderText"] = [[Paste Script Here]]
UI["c9"]["Size"] = UDim2.new(0.85, 0, 0.18, 0)
UI["c9"]["Position"] = UDim2.new(0.075, 0, 0.48, 0)
UI["c9"]["BorderColor3"] = Color3.fromRGB(0, 0, 0)
UI["c9"]["Text"] = [[]]
UI["c9"]["BackgroundTransparency"] = 0
...
UI["ca"]["CornerRadius"] = UDim.new(0, 6)
...
UI["cc"]["Transparency"] = 0.6
UI["cc"]["ApplyStrokeMode"] = Enum.ApplyStrokeMode.Border
UI["cc"]["Color"] = Color3.fromRGB(80, 80, 80)
...
UI["cd"]["TextSize"] = 18
UI["cd"]["FontFace"] = Font.new([[rbxasset://fonts/families/GothamSSm.json]], Enum.FontWeight.Bold, Enum.FontStyle.Normal)
UI["cd"]["TextColor3"] = Color3.fromRGB(255, 255, 255)
UI["cd"]["BackgroundTransparency"] = 1
UI["cd"]["Size"] = UDim2.new(1, 0, 0.15, 0)
UI["cd"]["BorderColor3"] = Color3.fromRGB(0, 0, 0)
UI["cd"]["Text"] = [[SAVE SCRIPT]]
UI["cd"]["Name"] = [[TextCreate]]
UI["cd"]["Position"] = UDim2.new(0, 0, 0.05, 0)
UI["cd"]["ZIndex"] = 2
...
UI["cf"]["CornerRadius"] = UDim.new(0, 8)
...
UI["d1"]["TextTransparency"] = 0
UI["d1"]["TextSize"] = 16
UI["d1"]["SelectionOrder"] = 1
UI["d1"]["TextColor3"] = Color3.fromRGB(255, 255, 255)
UI["d1"]["BackgroundColor3"] = Color3.fromRGB(194, 131, 106)
UI["d1"]["FontFace"] = Font.new([[rbxasset://fonts/families/GothamSSm.json]], Enum.FontWeight.Bold, Enum.FontStyle.Normal)
UI["d1"]["Size"] = UDim2.new(0.85, 0, 0.18, 0)
UI["d1"]["BackgroundTransparency"] = 0.2
UI["d1"]["Name"] = [[Create]]
UI["d1"]["BorderColor3"] = Color3.fromRGB(0, 0, 0)
UI["d1"]["Text"] = [[CREATE]]
UI["d1"]["Position"] = UDim2.new(0.075, 0, 0.75, 0)
UI["d1"]["ZIndex"] = 2

-- // StarterGui.RoniXUI.FolderFrame.Frame.CreateFrame.Create.UICorner \\ --
UI["d2"] = Instance.new("UICorner", UI["d1"])
UI["d2"]["CornerRadius"] = UDim.new(0, 6)

-- // StarterGui.RoniXUI.FolderFrame.Frame.CreateFrame.Create.UIStroke \\ --
UI["d3"] = Instance.new("UIStroke", UI["d1"])
UI["d3"]["Transparency"] = 0.5
...
UI["d4"]["TextSize"] = 16
UI["d4"]["TextColor3"] = Color3.fromRGB(200, 200, 200)
...
UI["d4"]["Size"] = UDim2.new(0.1, 0, 0.1, 0)
UI["d4"]["BackgroundTransparency"] = 1
UI["d4"]["Name"] = [[Exit]]
UI["d4"]["BorderColor3"] = Color3.fromRGB(0, 0, 0)
UI["d4"]["Text"] = [[X]]
UI["d4"]["Position"] = UDim2.new(0.88, 0, 0.02, 0)
UI["d4"]["ZIndex"] = 2
...
UI["dc"]["Color"] = Color3.fromRGB(51, 43, 89)
UI["dc"]["Thickness"] = 2
...
UI["dd"]["Image"] = asset_mgr.get(106985554407226);
...
UI["df"]["PlaceholderColor3"] = Color3.fromRGB(255, 255, 255)
...
UI["e1"]["Transparency"] = 0
UI["e1"]["ApplyStrokeMode"] = Enum.ApplyStrokeMode.Border
UI["e1"]["Color"] = Color3.fromRGB(62, 52, 107)
...
UI["e3"]["Size"] = UDim2.new(0.31, 0, 0.22, 0)
...
UI["e4"]["BackgroundColor3"] = Color3.fromRGB(20, 20, 20)
UI["e4"]["ScaleType"] = Enum.ScaleType.Crop
UI["e4"]["Image"] = asset_mgr.get(917173220219)
UI["e4"]["Size"] = UDim2.new(1, 0, 1, 0)
UI["e4"]["BorderColor3"] = Color3.fromRGB(0, 0, 0)
UI["e4"]["Position"] = UDim2.new(0, 0, 0, 0)
UI["e4"]["ClipsDescendants"] = true

-- // StarterGui.RoniXUI.SearchFrame.Frame.ScrollingFrame.Script.ImageLabel.UICorner \\ --
UI["e5"] = Instance.new("UICorner", UI["e4"])
UI["e5"]["CornerRadius"] = UDim.new(0, 8)

-- // Stroke para la carta principal \\ --
local MainStroke = Instance.new("UIStroke", UI["e4"])
...
UI["e6"]["BackgroundColor3"] = Color3.fromRGB(0, 0, 0)
...
UI["e8"]["TextSize"] = 16
UI["e8"]["FontFace"] = Font.new([[rbxasset://fonts/families/GothamSSm.json]], Enum.FontWeight.Bold, Enum.FontStyle.Normal)
UI["e8"]["TextColor3"] = Color3.fromRGB(255, 255, 255)
UI["e8"]["BackgroundTransparency"] = 1
UI["e8"]["Size"] = UDim2.new(0.9, 0, 0.2, 0)
UI["e8"]["BorderColor3"] = Color3.fromRGB(0, 0, 0)
UI["e8"]["Text"] = [[SIGMA NAME VERY LONG]]
UI["e8"]["Name"] = [[NameLabel]]
UI["e8"]["Position"] = UDim2.new(0.05, 0, 0.62, 0)
UI["e8"]["ZIndex"] = 2

-- // Stroke para el texto \\ --
local TextStroke = Instance.new("UIStroke", UI["e8"])
...
UI["e9"]["Size"] = UDim2.new(0.35, 0, 0.15, 0)
UI["e9"]["Position"] = UDim2.new(0.05, 0, 0.05, 0)
UI["e9"]["BorderColor3"] = Color3.fromRGB(0, 0, 0)
UI["e9"]["Name"] = [[UnverifiedLabel]]
UI["e9"]["BackgroundTransparency"] = 0.4
...
UI["ea"]["CornerRadius"] = UDim.new(0, 4)
...
UI["ec"]["Image"] = asset_mgr.get("badge-alert")
UI["ec"]["Size"] = UDim2.new(0.2, 0, 0.6, 0)
UI["ec"]["BorderColor3"] = Color3.fromRGB(0, 0, 0)
UI["ec"]["BackgroundTransparency"] = 1
UI["ec"]["Position"] = UDim2.new(0.05, 0, 0.2, 0)
...
UI["ed"]["TextSize"] = 14
UI["ed"]["FontFace"] = Font.new([[rbxasset://fonts/families/GothamSSm.json]], Enum.FontWeight.Bold, Enum.FontStyle.Normal)
UI["ed"]["TextColor3"] = Color3.fromRGB(237, 246, 71)
UI["ed"]["BackgroundTransparency"] = 1
UI["ed"]["Size"] = UDim2.new(0.65, 0, 0.6, 0)
UI["ed"]["BorderColor3"] = Color3.fromRGB(0, 0, 0)
UI["ed"]["Text"] = [[Unverified]]
UI["ed"]["Position"] = UDim2.new(0.3, 0, 0.2, 0)
...
UI["ee"]["BackgroundColor3"] = Color3.fromRGB(0, 0, 0)
UI["ee"]["Size"] = UDim2.new(0.35, 0, 0.15, 0)
UI["ee"]["Position"] = UDim2.new(0.05, 0, 0.05, 0)
UI["ee"]["BorderColor3"] = Color3.fromRGB(0, 0, 0)
UI["ee"]["Name"] = [[VerifiedLabel]]
UI["ee"]["BackgroundTransparency"] = 0.4
...
UI["ef"]["CornerRadius"] = UDim.new(0, 4)
...
UI["f1"]["Image"] = asset_mgr.get("badge-check")
UI["f1"]["Size"] = UDim2.new(0.2, 0, 0.6, 0)
UI["f1"]["BorderColor3"] = Color3.fromRGB(0, 0, 0)
UI["f1"]["BackgroundTransparency"] = 1
UI["f1"]["Position"] = UDim2.new(0.05, 0, 0.2, 0)
...
UI["f2"]["TextSize"] = 14
UI["f2"]["FontFace"] = Font.new([[rbxasset://fonts/families/GothamSSm.json]], Enum.FontWeight.Bold, Enum.FontStyle.Normal)
UI["f2"]["TextColor3"] = Color3.fromRGB(0, 241, 246)
UI["f2"]["BackgroundTransparency"] = 1
UI["f2"]["Size"] = UDim2.new(0.65, 0, 0.6, 0)
UI["f2"]["BorderColor3"] = Color3.fromRGB(0, 0, 0)
UI["f2"]["Text"] = [[Verified]]
UI["f2"]["Position"] = UDim2.new(0.3, 0, 0.2, 0)
...
UI["f3"]["BackgroundColor3"] = Color3.fromRGB(0, 0, 0)
UI["f3"]["Size"] = UDim2.new(0.25, 0, 0.15, 0)
UI["f3"]["Position"] = UDim2.new(0.7, 0, 0.05, 0)
UI["f3"]["BorderColor3"] = Color3.fromRGB(0, 0, 0)
UI["f3"]["Name"] = [[ViewLabel]]
UI["f3"]["BackgroundTransparency"] = 0.4
...
UI["f5"]["CornerRadius"] = UDim.new(0, 4)
...
UI["f6"]["Image"] = asset_mgr.get("scan-eye")
UI["f6"]["Size"] = UDim2.new(0.3, 0, 0.6, 0)
UI["f6"]["BorderColor3"] = Color3.fromRGB(0, 0, 0)
UI["f6"]["BackgroundTransparency"] = 1
UI["f6"]["Position"] = UDim2.new(0.05, 0, 0.2, 0)
...
UI["f7"]["TextSize"] = 14
UI["f7"]["FontFace"] = Font.new([[rbxasset://fonts/families/GothamSSm.json]], Enum.FontWeight.Bold, Enum.FontStyle.Normal)
UI["f7"]["TextColor3"] = Color3.fromRGB(83, 224, 250)
UI["f7"]["BackgroundTransparency"] = 1
UI["f7"]["Size"] = UDim2.new(0.55, 0, 0.6, 0)
UI["f7"]["BorderColor3"] = Color3.fromRGB(0, 0, 0)
UI["f7"]["Text"] = [[40K]]
UI["f7"]["Position"] = UDim2.new(0.4, 0, 0.2, 0)
-- // StarterGui.RoniXUI.SearchFrame.Frame.ScrollingFrame.UIGridLayout \\ --
UI["f8"] = Instance.new("UIGridLayout", UI["e2"])
UI["f8"]["CellSize"] = UDim2.new(0.32, 0, 0.166, 0)
UI["f8"]["SortOrder"] = Enum.SortOrder.LayoutOrder
UI["f8"]["CellPadding"] = UDim2.new(0.01, 0, 0.004, 0)
...
UI["100"]["Image"] = asset_mgr.get(109560465642622);
...
local function Add_Tab(NameScript, ScriptCode)
    ...
    Button.Delete.MouseButton1Click:Connect(function()
        ...
        if isfile(Folder .. "/" .. FileName) then
            delfile(Folder .. "/" .. FileName)
        end
    end)

    if not isfile(Folder .. "/" .. FileName) then
        writefile(Folder .. "/" .. FileName, ScriptCode)
    end
end
...
CreateButton.MouseButton1Click:Connect(function()
    ...
    if CreateFrame.Visible and TextNameScript.Text ~= "" and TextScriptCode.Text ~= "" then
        ...
        if isfile(Folder .. "/" .. TextNameScript.Text) then
            local ScriptFrame = script.Parent:WaitForChild("ScrollingFrame"):FindFirstChild("ScriptFrame")
            ...
            ErrorCard.Parent = script.Parent:WaitForChild("ScrollingFrame")
...
task.spawn(function()
    for _, v in pairs(listfiles(Folder)) do
        if isfile(v) then
            local name = v:match("([^\\/]+)$")
            local displayName = name:gsub("%.lua$", "")
            local contents = readfile(v)
            Add_Tab(displayName, contents)
        end
    end
end)
end
...
local Tabs = {
	...
	ronixButton.MouseButton1Click:Connect(function()
        ...
        if lastActiveTab then
            TweenTab(lastActiveTab.Frame, lastActiveTab.TargetPosition, 0)
        end
	end)
...
function Script_Anim()
	...
	CreateAnimatedBorder(UI["8"])
end
task.spawn(Script_Anim)
...
function Start_ANIM()
    ...
    task.spawn(function()
        while not State.IsDestroyed and UI.AnimatedBorder and UI.AnimatedBorder.Frame.Parent do
            ...
            local tween = TweenService:Create(UI.AnimatedBorder.Gradient,
    ...
    task.spawn(function()
        while not State.IsDestroyed and UI.Header and UI.Header.IconGlow and UI.Header.IconGlow.Parent do
            ...
            State.Animations.IconTween = TweenService:Create(UI.Header.IconGlow,
...
repeat task.wait() until game:IsLoaded( ) --// i hate this/
_dtc_.pushautoexec();
